...
import { BookOpen, UserCheck, BarChart3, Sparkles, Settings, Code2, Database, Layers, CheckCircle2, ChevronDown, ChevronUp, Cpu, ShieldCheck, Cloud, Server, Globe, ArrowRight, LayoutList, Target, User, Flag, Rocket, Lock, Key, MousePointerClick, AlertTriangle, Download } from 'lucide-react';
      ...
      <div className="space-y-4">
        ...
        {openSection === 'aws_manual' && (
          <div className="bg-white dark:bg-slate-800 p-6 rounded-xl border border-slate-200 dark:border-slate-700 space-y-8 animate-fade-in-down">
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg border border-yellow-200 dark:border-yellow-800 flex gap-3 items-start">
               <AlertTriangle className="text-yellow-600 shrink-0 mt-1" />
               <div>
                  <h4 className="font-bold text-yellow-800 dark:text-yellow-200">Erro: "npm não reconhecido"?</h4>
                  <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-1">
                     Se o seu terminal der erro ao digitar npm, você precisa instalar o <strong>Node.js</strong>.
                     <br/>
                     <a href="https://nodejs.org/" target="_blank" className="underline font-bold hover:text-orange-500">Clique aqui para baixar o Node.js LTS</a>.
                     <br/>
